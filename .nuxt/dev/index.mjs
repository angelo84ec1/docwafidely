...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, readBody, getQuery as getQuery$1, getRequestHost, setHeader, getResponseStatusText } from 'file:///Users/angeloluna/Documents/appwafidely/appdoc/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/angeloluna/Documents/appwafidely/appdoc/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/angeloluna/Documents/appwafidely/appdoc/node_modules/devalue/index.js';
import destr from 'file:///Users/angeloluna/Documents/appwafidely/appdoc/node_modules/destr/dist/index.mjs';
import { hash } from 'file:///Users/angeloluna/Documents/appwafidely/appdoc/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///Users/angeloluna/Documents/appwafidely/appdoc/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/angeloluna/Documents/appwafidely/appdoc/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/angeloluna/Documents/appwafidely/appdoc/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/angeloluna/Documents/appwafidely/appdoc/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/angeloluna/Documents/appwafidely/appdoc/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/angeloluna/Documents/appwafidely/appdoc/node_modules/scule/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/angeloluna/Documents/appwafidely/appdoc/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/angeloluna/Documents/appwafidely/appdoc/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/angeloluna/Documents/appwafidely/appdoc/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/angeloluna/Documents/appwafidely/appdoc/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///Users/angeloluna/Documents/appwafidely/appdoc/node_modules/unctx/dist/index.mjs';
import { unref, version } from 'file:///Users/angeloluna/Documents/appwafidely/appdoc/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/angeloluna/Documents/appwafidely/appdoc/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/angeloluna/Documents/appwafidely/appdoc/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/angeloluna/Documents/appwafidely/appdoc/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/angeloluna/Documents/appwafidely/appdoc","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/angeloluna/Documents/appwafidely/appdoc/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/angeloluna/Documents/appwafidely/appdoc/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/angeloluna/Documents/appwafidely/appdoc/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/angeloluna/Documents/appwafidely/appdoc/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _yyyPKJ8Ux0 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/angeloluna/Documents/appwafidely/appdoc";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _roXjYuDXAD = (nitroApp) => {
...
const _lazy_VJnkqz = () => Promise.resolve().then(function () { return login_get$1; });
const _lazy_ip13GE = () => Promise.resolve().then(function () { return robots_txt$1; });
const _lazy_wi2OsX = () => Promise.resolve().then(function () { return sitemap_xml$1; });
const _lazy_8T3KXe = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/login', handler: _lazy_VJnkqz, lazy: true, middleware: false, method: "get" },
  { route: '/robots.txt', handler: _lazy_ip13GE, lazy: true, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _lazy_wi2OsX, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_8T3KXe, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_8T3KXe, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Desarrollo de web a la medida - Desarrollo de Apps - Entrenamiento de Agentes IA - Programadores Full Stack - Desarrollo Sistemas SAAS - Arquitectos de Cloud."},{"name":"format-detection","content":"telephone=no"},{"name":"keywords","content":"Desarrollo web - Desarrollo apps- Entrenamiento de agentes con inteligencia artificial - Bots en whatsapp - Sistema de agendamiento de citas con agentes de IA en whatsapp"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"},{"rel":"stylesheet","href":"https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.0/css/all.min.css"}],"style":[],"script":[{"src":"https://www.paypal.com/sdk/js?client-id=test&currency=USD","async":true}],"noscript":[],"titleTemplate":"%s - Wafidely","title":"Wafidely - Sistema agendamiento de citas web y whatsapp - Confirmacion asistencia por whatsapp - Sistema recordatorio vacunas en whatsapp mascotas - Api Whatsapp para N8N - Bot en Whatsapp - Agentes Inteligencia Artifical - AI Agent USA - Agencias creacion Agentes IA en Republica Dominicana - Agencias creacion Agentes IA en México ","htmlAttrs":{"lang":"es"}};
...
const getClientManifest = () => import('file:///Users/angeloluna/Documents/appwafidely/appdoc/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
