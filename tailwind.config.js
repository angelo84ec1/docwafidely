  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        // Animaciones adicionales para Wafidely
        fadeIn: {
      ...
      colors: {
        ...
        // Colores corporativos de Wafidely
      ...
      backgroundImage: {
        'gradient-wafidely': 'linear-gradient(135deg, #25D366 0%, #2563EB 100%)',
        'gradient-wafidely-light': 'linear-gradient(135deg, #DCF8C6 0%, #DBEAFE 100%)',
